...
export const ITEMS: ItemDefinition[] = [
  { classname: 'item_health_small', kind: 'health', amount: 5, limit: 200, respawn: 35, label: '+5 SANTE' },
  { classname: 'item_health', kind: 'health', amount: 25, respawn: 35, label: '+25 SANTE' },
  { classname: 'item_health_large', kind: 'health', amount: 50, respawn: 35, label: '+50 SANTE' },
  { classname: 'item_health_mega', kind: 'health', amount: 100, limit: 200, respawn: 35, label: 'MEGA SANTE' },
  { classname: 'item_armor_shard', kind: 'armor', amount: 5, respawn: 25, label: '+5 ARMURE' },
  { classname: 'item_armor_combat', kind: 'armor', amount: 50, respawn: 25, label: '+50 ARMURE' },
  { classname: 'item_armor_body', kind: 'armor', amount: 100, respawn: 25, label: '+100 ARMURE' },
  { classname: 'ammo_bullets', kind: 'ammo', amount: 50, ammoType: 'bullets', respawn: 40, label: '+50 BALLES' },
  { classname: 'ammo_shells', kind: 'ammo', amount: 10, ammoType: 'shells', respawn: 40, label: '+10 CARTOUCHES' },
  { classname: 'ammo_grenades', kind: 'ammo', amount: 5, ammoType: 'grenades', respawn: 40, label: '+5 GRENADES' },
  { classname: 'ammo_rockets', kind: 'ammo', amount: 5, ammoType: 'rockets', respawn: 40, label: '+5 ROQUETTES' },
  { classname: 'ammo_lightning', kind: 'ammo', amount: 60, ammoType: 'lightning', respawn: 40, label: '+60 ECLAIRS' },
  { classname: 'ammo_slugs', kind: 'ammo', amount: 10, ammoType: 'slugs', respawn: 40, label: '+10 PROJECTILES' },
  { classname: 'ammo_cells', kind: 'ammo', amount: 30, ammoType: 'cells', respawn: 40, label: '+30 CELLULES' },
  { classname: 'ammo_bfg', kind: 'ammo', amount: 15, ammoType: 'bfg', respawn: 40, label: '+15 CHARGES' },
  { classname: 'weapon_machinegun', kind: 'weapon', amount: 50, weapon: 'machinegun', ammoType: 'bullets', respawn: 5, label: 'MITRAILLEUSE' },
  { classname: 'weapon_shotgun', kind: 'weapon', amount: 10, weapon: 'shotgun', ammoType: 'shells', respawn: 5, label: 'FUSIL A POMPE' },
  { classname: 'weapon_grenadelauncher', kind: 'weapon', amount: 10, weapon: 'grenade', ammoType: 'grenades', respawn: 5, label: 'LANCE-GRENADES' },
  { classname: 'weapon_rocketlauncher', kind: 'weapon', amount: 10, weapon: 'rocket', ammoType: 'rockets', respawn: 5, label: 'LANCE-ROQUETTES' },
  { classname: 'weapon_lightning', kind: 'weapon', amount: 100, weapon: 'lightning', ammoType: 'lightning', respawn: 5, label: 'FUSIL A ECLAIRS' },
  { classname: 'weapon_railgun', kind: 'weapon', amount: 10, weapon: 'railgun', ammoType: 'slugs', respawn: 5, label: 'RAILGUN' },
  { classname: 'weapon_plasmagun', kind: 'weapon', amount: 50, weapon: 'plasma', ammoType: 'cells', respawn: 5, label: 'FUSIL A PLASMA' },
